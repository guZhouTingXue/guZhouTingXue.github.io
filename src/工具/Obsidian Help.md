...
>[!note]
>只能使用\[\[\#block-identifier]]来进行链接（esc退出ob自动补全/修改链接格式）
...
<span style="background:#fff88f">问题：</span>这里链接不能够起别名？
...
![|300x119](./attachments/Obsidian%20Help-2.webp)

点击 Open Link 能够打开对应位置的文件


<span style="background:#fff88f">问：</span>只能使用markdown 链接？使用\[\[ 不会进行提示
