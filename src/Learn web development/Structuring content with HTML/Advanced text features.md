...
- 同一个日期显示格式可以不同
- 具体时间的范围（精细度/颗粒度）可以是时、日、月。。。
- time element 规定了日期的格式，截取部分如下：

| Description           | Microsyntax                | Examples                         |
| --------------------- | -------------------------- | -------------------------------- |
| Valid month string    | YYYY-MM                    | 2011-11, 2013-05                 |
| Valid date string     | YYYY-MM-DD                 | 1970-03-01                       |
| Valid duration string | PdDThHmMsS<br>PdDThHmMs.XS | P12DT7H12M12S<br>P12DT7H12M12.3S |
