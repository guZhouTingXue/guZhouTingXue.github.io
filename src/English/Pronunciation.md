...
| 清   | p   | t   | k   | f   | s   | θ   | ʃ   | tʃ  | tr  | ts  | h   |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 示例  |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |
| 浊   | b   | d   | g   | v   | z   | ð   | ʒ   | dʒ  | dr  | dz  |     | m   | n   | ŋ   | r   | l   | w   | j   |
| 示例  |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |

>成对的(清浊)辅音发音在发音部位和方法上基本相同，差别只在于发音时声带振动与否
...
**声带 Vocal cords - 发音体**
两片肌肉
![|301x236](./attachments/Pronunciation-2.webp)
...
可以看到，示例发音嘴型鼻子边上的脸颊明显凹了下去，脖子上的（应该是静脉）浮现。
（我没有脖子，但是用手摸着脖子，发音的时候可以感受到脖子被牵动）

短音 ɪ
![ɪ](attachments/pronunciation-i.gif)
>核心
>嘴角放松，轻轻弹出

示例的嘴型是嘴巴自然张开，嘴角微咧，上下齿之间空隙很小
实际我发这个音的时候，不咧嘴角，上下齿之间的间隙比示例图稍大
...
一般情况：陈述语气，不带感情。
发音方式：参与发音的器官，发音的过程
	而不是发音的时长：短元音也可延长发音时间。但不改变其长、短性质

通过对 iː 和 ɪ 的学习，可以知道他们一个长音、一个短音 之间没有联系，发音方式、特点 等均不相同。=》没有配对的长、短元音，它们是独立的个体
...
## 资源
- [phonchart2008.pdf](/resources/English/Pronunciation/phonchart2008.pdf)
