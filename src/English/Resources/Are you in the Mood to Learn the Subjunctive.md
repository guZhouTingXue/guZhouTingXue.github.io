...
---
<VidStack
	src="/resources/English/7_Verbs/Mood/Are_you_in_the_Mood_to_Learn_the_Subjunctive.mp3"
	:tracks="[
	  {
		  src: '/resources/English/7_Verbs/Mood/Are_you_in_the_Mood_to_Learn_the_Subjunctive.vtt',
		  kind: 'chapters',
		  language: 'en-US',
		  default: true,
	  },
...
* Subjunctive
	**:  概述
	use the subjunctive to express a wide variety of unreal or possible situations
	use the subjunctive with a noun clause to express urgency or importance.
	example: "I suggest that you arrive early";
	**: Polite, yet urgent
		对比
		“Stop eating with your hands." 
		"It is important that you eat with a fork."
		使用条件
		"In most situations, the speaker using the subjunctive has power over the listener."
		mother-》child、boss-》employee
		;
	**: verb + that + object +simple verb
	更礼貌的表达要求、命令
	- that is optional
	- "His father demanded that he join the army.
	- "I demand that you shoot me now."
	;
	**: It is + adjective + that + object + simple verb
	强调 urgency or importance
	- "It is vital that he take his medicine."
...
### It is + adjective + that + simple verb 
...
| senator<br>/ˈsenətə(r)/ | a member of THE SENATE                     |                                                                                             | 参议员   |           |
...
- be likely to do something: You are likely to hear
...
## 资源
[mp3](/resources/English/7_Verbs/Mood/Are_you_in_the_Mood_to_Learn_the_Subjunctive.mp3)
[pdf](/resources/English/7_Verbs/Mood/Are_you_in_the_Mood_to_Learn_the_Subjunctive.pdf)
